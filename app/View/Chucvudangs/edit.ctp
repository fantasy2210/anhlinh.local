<div class="chucvudangs form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Chucvudang'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Chucvudang', array('role' => 'form','formStyle' => 'horizontal2')); ?>
