<div class="capbacs view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Capbac'); ?></h1>
			</div>
		</div>
	</div>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($capbac['Danhsach'] as $danhsach): ?>
		<tr>
...
<div class="related row">
	...
	<?php if (!empty($capbac['Quatrinhcongtac'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($capbac['Quatrinhcongtac'] as $quatrinhcongtac): ?>
		<tr>
