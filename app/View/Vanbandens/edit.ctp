...
<?php //pr($this->data); ?>
	<div class="row">		
		...
		<div class="panel-heading"><?php echo __('Edit Vanbanden'); ?></div>
			...
			<?php echo $this->Form->input('loaivanban_id', array('class' => 'form-control select2'));?>
			...
			<?php echo $this->Form->input('noigui_id', array('class' => 'form-control select2'));?>
			...
			<?php echo $this->Form->input('linhvuc_id', array('class' => 'form-control select2'));?>
			<?php //echo $this->Form->input('nguoiduyet_id', array('class' => 'form-control'));?>
			<?php echo $this->Form->input('nguoinhan_id', array('type' => 'hidden','class' => 'form-control'));?>
...
<?php $vanbandens = $this->request->data; ?>
<script>
var mockFile = <?php echo json_encode($files); ?>
</script>
<?php
