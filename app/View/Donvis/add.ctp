<div class="donvis form">
	...
	<div class="row">		
		...
		<div class="panel-heading"><?php echo __('Add Donvi'); ?></div>
			...
			<?php echo $this->Form->create('Donvi', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('huyen_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('xa_id', array('class' => 'form-control'));?>
		</div>
