<div class="chucvuchinhquyens view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Chucvuchinhquyen'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<td>
			<?php echo h($chucvuchinhquyen['Chucvuchinhquyen']['id']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($chucvuchinhquyen['Chucvuchinhquyen']['ten']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($chucvuchinhquyen['Danhsach'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($chucvuchinhquyen['Danhsach'] as $danhsach): ?>
		<tr>
...
<div class="related row">
	...
	<?php if (!empty($chucvuchinhquyen['Quatrinhcongtac'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($chucvuchinhquyen['Quatrinhcongtac'] as $quatrinhcongtac): ?>
		<tr>
