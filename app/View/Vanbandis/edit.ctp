<div class="vanbandis form">
	...
	<div class="row">		
		...
		<div class="panel-heading"><?php echo __('Edit Vanbandi'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Vanbandi', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('so', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('kyhieu', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('loaivanban_id', array('class' => 'form-control'));?>
					...
					<?php echo $this->Form->input('nguoiky_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('domat', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('linhvuc_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('noidungvanban', array('class' => 'form-control'));?>
