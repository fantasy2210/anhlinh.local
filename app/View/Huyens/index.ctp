	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="portlet-header pam mbn">
				<div class="caption"><?php echo __('Huyens'); ?></div>
				<div class="actions">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($huyens as $huyen): ?>
					<tr>
						<td><?php echo h($huyen['Huyen']['id']); ?>&nbsp;</td>
						<td><?php echo h($huyen['Huyen']['ten']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($huyen['Tinh']['ten'], array('controller' => 'tinhs', 'action' => 'view', $huyen['Tinh']['id'])); ?>
		</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $huyen['Huyen']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $huyen['Huyen']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $huyen['Huyen']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $huyen['Huyen']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
