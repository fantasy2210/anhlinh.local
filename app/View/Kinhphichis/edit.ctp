<div class="kinhphichis form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Kinhphichi'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Kinhphichi', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('noidung', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('nguonkinhphi', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('sotien', array('class' => 'form-control'));?>
