...
<div class="row">		
    <div class="col-md-12">		
        <div class="panel panel-default">
            <div class="panel-heading"><?php echo __('Add Tinh Hinh Ven Bien'); ?></div>
            <div class="panel-body">
                ...
                ?>
                <?php
                echo $this->Form->input('huyen_id', array('class' => 'form-control', 'after' => $this->Html->link('<span class="glyphicon glyphicon-plus"></span> Thêm huyện', '#', array('escape' => false, 'class' => 'fancybox-load btn btn-success',
...
<?php $this->Html->script('add-tinh', array('block' => 'scriptBottom', 'inline' => false)); ?>
<?php $this->Html->script('add-huyen', array('block' => 'scriptBottom', 'inline' => false)); ?>
<?php $this->Html->script('add-xa', array('block' => 'scriptBottom', 'inline' => false)); ?>
