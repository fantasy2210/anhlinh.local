	...
	<div class="row">		
		...
		<div class="panel-heading"><?php echo __('Add Tinhhinh'); ?></div>
			...
			<?php echo $this->Form->create('Tinhhinh', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('thoigian', array('class' => 'datetimepicker-default form-control','data-date-format'=>"dd/mm/yyyy",'type'=>"text"));?>
					...
					<?php echo $this->Form->input('dao_id', array('class' => 'form-control select2','empty' =>"Vui lòng chọn"));?>
					<?php echo $this->Form->input('vungbien_id', array('class' => 'form-control select2','empty' =>"Vui lòng chọn"));?>
					<?php echo $this->Form->input('quocgia_id', array('class' => 'form-control select2','empty' =>"Vui lòng chọn"));?>
					<?php echo $this->Form->input('tauca_id', array('class' => 'form-control select2','empty' =>"Vui lòng chọn"));?>
		</div>
...
?>
<?php
$this->Html->script('tinhhinh_tentau', array('block' => 'scriptBottom','inline' => false));
?>