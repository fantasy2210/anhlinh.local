<div class="quanhegiadinhs form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Quanhegiadinh'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Quanhegiadinh', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('hovaten', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('namsinh', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('quenquan', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('nghenghiep', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('tinhtrang', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('loaiquanhe_id', array('class' => 'form-control'));?>
