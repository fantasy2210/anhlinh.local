<div class="noiguis form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Noigui'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Noigui', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('ten', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('diachi', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('dienthoai', array('class' => 'form-control'));?>
		</div>
