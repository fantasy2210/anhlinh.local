<div class="baocaotins form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Baocaotin'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Baocaotin', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('thoigiannamtin', array('class' => 'datepicker-default form-control','data-date-format'=>"dd/mm/yyyy",'type'=>"text"));?>
					<?php echo $this->Form->input('thoigianbaocao', array('class' => 'datepicker-default form-control','data-date-format'=>"dd/mm/yyyy",'type'=>"text"));?>
					<?php echo $this->Form->input('noidungtin', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('nguontin', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('bienphapxuly', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('dexuat', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('tunhanxet', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('ykienchihuy', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('danhsach_id', array('class' => 'form-control'));?>
		</div>
