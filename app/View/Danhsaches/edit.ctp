<div class="danhsaches form">
	...
	<div class="row">		
		...
		<div class="panel-heading"><?php echo __('Edit Danhsach'); ?></div>
			...
			<?php echo $this->Form->create('Danhsach', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('donvi_id', array('class' => 'form-control'));?>
					...
					<?php echo $this->Form->input('Quanhegiadinh', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('Quatrinhcongtac', array('class' => 'form-control'));?>
		</div>
