	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="portlet-header pam mbn">
				<div class="caption"><?php echo __('Danhsaches'); ?></div>
				<div class="actions">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('ngaysinh'); ?></th>
						<th><?php echo $this->Paginator->sort('ngaynhapngu'); ?></th>
						<th><?php echo $this->Paginator->sort('quequan'); ?></th>
						<th><?php echo $this->Paginator->sort('noithuongtru'); ?></th>
				...
				<tbody>
				<?php foreach ($danhsaches as $danhsach): ?>
					<tr>
						<td><?php echo h($danhsach['Danhsach']['id']); ?>&nbsp;</td>
						<td><?php echo h($danhsach['Danhsach']['hovaten']); ?>&nbsp;</td>
						<td><?php echo h($danhsach['Danhsach']['ngaysinh']); ?>&nbsp;</td>
						<td><?php echo h($danhsach['Danhsach']['ngaynhapngu']); ?>&nbsp;</td>
						<td><?php echo h($danhsach['Danhsach']['quequan']); ?>&nbsp;</td>
						<td><?php echo h($danhsach['Danhsach']['noithuongtru']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($danhsach['Capbac']['ten'], array('controller' => 'capbacs', 'action' => 'view', $danhsach['Capbac']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $danhsach['Danhsach']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $danhsach['Danhsach']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $danhsach['Danhsach']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $danhsach['Danhsach']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
