<div class="linhvucs view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Linhvuc'); ?></h1>
			</div>
		</div>
	</div>
...
<tr>
		...
		<td>
			<?php echo h($linhvuc['Linhvuc']['ten']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($linhvuc['Vanbanden'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($linhvuc['Vanbanden'] as $vanbanden): ?>
		<tr>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($linhvuc['Vanbandi'] as $vanbandi): ?>
		<tr>
