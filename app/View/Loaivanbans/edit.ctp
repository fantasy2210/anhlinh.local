<div class="loaivanbans form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Loaivanban'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Loaivanban', array('role' => 'form','formStyle' => 'horizontal2')); ?>
