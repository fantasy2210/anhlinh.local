<div class="ykiendonggops form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Ykiendonggop'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Ykiendonggop', array('role' => 'form','formStyle' => 'horizontal2')); ?>
					...
					<?php echo $this->Form->input('lydo', array('class' => 'form-control'));?>
