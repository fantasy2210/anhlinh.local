<div class="nhomvcs form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Nhomvc'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Nhomvc', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('tennhom', array('class' => 'form-control'));?>
		</div>
