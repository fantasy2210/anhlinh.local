<div class="taucannbatgius form">

	<div class="row">		
		<div class="col-md-12">		
		<div class="panel panel-default">
		<div class="panel-heading"><?php echo __('Edit Taucannbatgius'); ?></div>
						<div class="panel-body">
			<?php echo $this->Form->create('Taucannbatgiu', array('role' => 'form','formStyle' => 'horizontal2')); ?>

					<?php echo $this->Form->input('id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('thoigian', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('toado', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('quocgia_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('vungbien_id', array('class' => 'form-control'));?>
					<?php echo $this->Form->input('tauca_id', array('class' => 'form-control'));?>
		</div>
