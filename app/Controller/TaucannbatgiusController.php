...
class TaucannbatgiusController extends AppController {
    ...
    public function add() {
        if ($this->request->is('post')) {
            ...
            if (!empty($this->request->data['Taucannbatgiu']['thoigian'])) {
                $this->request->data['Taucannbatgiu']['thoigian'] = date('Y-m-d H:i', strtotime($this->request->data['Taucannbatgiu']['thoigian']));
            }
        ...
        $quocgias = $this->Taucannbatgiu->Quocgia->find('list');
        $vungbiens = $this->Taucannbatgiu->Vungbien->find('list');
        $taucas = $this->Taucannbatgiu->Tauca->find('list');
        $this->set(compact('quocgias', 'vungbiens', 'taucas'));
    }
