	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="portlet-header pam mbn">
				<div class="caption"><?php echo "<?php echo __('{$pluralHumanName}'); ?>"; ?></div>
				<div class="actions">
				<?php echo "<?php echo \$this->Html->link(__('<i class=\"fa fa-plus\"></i>&nbsp;Thêm mới'), array('action' => 'add'), array('escape' => false,'class'=>'btn btn-info btn-sm')); ?>"; ?>
					<div class="btn-group"><a href="#" data-toggle="dropdown" class="btn btn-warning btn-sm dropdown-toggle"><i class="fa fa-wrench"></i>&nbsp;Công cụ</a>
